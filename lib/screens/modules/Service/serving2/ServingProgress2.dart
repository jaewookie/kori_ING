...
class ServingProgress2 extends StatefulWidget {
  const ServingProgress2({Key? key}) : super(key: key);

  @override
  State<ServingProgress2> createState() => _ServingProgress2State();
}

class _ServingProgress2State extends State<ServingProgress2> {
