...
class ServingProgress extends StatefulWidget {
  const ServingProgress({Key? key}) : super(key: key);

  @override
  State<ServingProgress> createState() => _ServingProgressState();
}

class _ServingProgressState extends State<ServingProgress> {
  ...
  // late List<String> tableNewDestinations = [];
  // late List<String> itemNewDestinations = [];
