...
import 'package:kori_test_refactoring/screens/modules/Service/serving/TrayChecker.dart';
...
class ServingMenu extends StatefulWidget {
  ServingMenu({Key? key}) : super(key: key);

  @override
  State<ServingMenu> createState() => _ServingMenuState();
}

class _ServingMenuState extends State<ServingMenu> {
  ...
  List<String> testItems = ['햄버거', '피자', '국밥', '미주문'];
              ...
              child: Row(
                ...
                children: [
                  Container(
                      ...
                      child: Padding(
                        // padding: EdgeInsets.only(left: textButtonWidth*0.1),
                                      ...
                                      for (int j = (2 * i);
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            OrderedMenuButtons(
                                                onPressed: () {
                                                  navPage(context: context, page: TrayChecker(), enablePop: true).navPageToPage();
