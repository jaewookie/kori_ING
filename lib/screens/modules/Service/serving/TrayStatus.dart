...
class TrayStatus extends StatefulWidget {
  const TrayStatus({Key? key}) : super(key: key);

  @override
  State<TrayStatus> createState() => _TrayStatusState();
}

class _TrayStatusState extends State<TrayStatus> {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        // Text('x번 테이블 ', style: textFont2),
                        // Text('상품명', style: textFont2),
                      ],
                    ),
                  ],
                ),
