...
class SelectTableModal extends StatefulWidget {
  const SelectTableModal({Key? key})
      : super(key: key);

  @override
  State<SelectTableModal> createState() => _SelectTableModalState();
}

class _SelectTableModalState extends State<SelectTableModal> {
