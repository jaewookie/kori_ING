...
class TableSelectImg extends StatefulWidget {
  const TableSelectImg({Key? key}) : super(key: key);

  @override
  State<TableSelectImg> createState() => _TableSelectImgState();
}

class _TableSelectImgState extends State<TableSelectImg> {
  ...
  Widget build(BuildContext context) {
    ...
    String tableImg = 'assets/images/serving_menu_img/tables.png';
      ...
      Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage(tableImg), fit: BoxFit.fitHeight),
          ),
          width: screenWidth,
          height: screenHeight,
          child: Stack(
