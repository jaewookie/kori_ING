...
class _CheckOutScreenState extends State<CheckOutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < (orderedItems.length); i++) {
      if (orderedItems[i] == '햄버거') {
        orderedImgSelection = 0;
      } else if (orderedItems[i] == '라면') {
        orderedImgSelection = 1;
      } else if (orderedItems[i] == '치킨') {
        orderedImgSelection = 2;
      } else {
        orderedImgSelection = 3;
      }
    }
